...
function ListingForm({ draftIdFromProps }: { draftIdFromProps?: string }) {
  ...
  const autoSaveDraft = useCallback(async () => {
    if (status !== 'authenticated') return
    if (initialStatus === 'PUBLISHED') return // DO NOT auto-save if editing a published listing
...
export default function ListingFormWrapper(props: { draftIdFromProps?: string }) {
  return (
