...
export default function AdminNonOrlandoPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl">
      ...
      {/* Table — No Views or Saved columns; "Subscription Start" renamed to "Request Date" */}
            ...
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50/80">
                {[
                  ...
                  { label: 'Lister', field: '' },
                  { label: 'Status', field: '' },
                  { label: 'Request Date', field: 'createdAt' },
              ...
              {loading ? (
                ...
                properties.map((prop) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4 text-sm font-semibold text-slate-600">{prop.city}, {prop.state}</td>
                  </tr>
                ))
              )}
            </tbody>
